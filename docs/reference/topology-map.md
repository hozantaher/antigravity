...
### `scrapers`
- **Cesta:** `products/hozan-taher/features/acquisition/scrapers`
- **Osa příběhu (Story Axis):** legacy
- **Stav:** met
...
### `auth-account`
- **Cesta:** `products/auction24/features/platform/auth-account`
- **Osa příběhu (Story Axis):** platform
- **Stav:** met
...
### `registration`
- **Cesta:** `products/auction24/features/platform/auth-account/registration`
- **Osa příběhu (Story Axis):** platform
- **Stav:** met

### `password-reset`
- **Cesta:** `products/auction24/features/platform/auth-account/password-reset`
- **Osa příběhu (Story Axis):** platform
- **Stav:** met

### `guards`
- **Cesta:** `products/auction24/features/platform/auth-account/guards`
- **Osa příběhu (Story Axis):** platform
- **Stav:** met
