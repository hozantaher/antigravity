...
import { createDb } from '../../spine/engine/acquisition/autoline/db.js';
import { runDetailPhase } from '../../spine/engine/acquisition/autoline/scraper.js';
import { runSitemapPhase } from '../../spine/engine/acquisition/autoline/sitemap.js';
import type { ScraperConfig } from '../../spine/engine/acquisition/autoline/types.js';
...
console.log('Autoline Scraper [Running via Antigravity]');
...
if (values.daemon) {
  ...
  const listener = createCommandListener('autoline', async (payload) => {
