...
import type { DepositMethod } from '~/models'
...
const options: MethodOption[] = [
  {
    ...
    titleKey: 'deposit.method.card',
    hintKey: 'deposit.method.cardHint',
  },
  {
    method: 'transfer',
    icon: 'heroicons-outline:library',
    titleKey: 'deposit.method.transfer',
    hintKey: 'deposit.method.transferHint',
  },
]

const selected = ref<DepositMethod>()
...
<template>
  <div class="step">
    <h4 class="step-heading">{{ t('deposit.method.heading') }}</h4>
    <p class="step-intro">{{ t('deposit.method.intro') }}</p>
